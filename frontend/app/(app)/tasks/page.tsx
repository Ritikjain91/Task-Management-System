...
export default function TasksPage() {
  ...
  const { tasks, loading, patchTask, removeTask, addTask } = useTasks(activeWorkspace?.id);
    ...
    <div className="flex h-full flex-col">
      <header className="flex flex-col gap-3 border-b border-[var(--color-border)] px-4 py-4 sm:px-6 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <FieldsMenu view={view} onViewChange={changeView} fields={fields} onToggleField={toggleField} />
          <button
            type="button"
